...
import org.harsh.tickets.exceptions.EventNotFoundException;
import org.harsh.tickets.exceptions.EventUpdateException;
import org.harsh.tickets.exceptions.TicketTypeNotFoundException;
import org.harsh.tickets.exceptions.UserNotFoundException;
import org.harsh.tickets.repositories.EventRepository;
import org.harsh.tickets.repositories.UserRepository;
import org.harsh.tickets.services.EventService;
...
public class EventServiceImpl implements EventService {
    ...
    public Event updateEventForOrganizer(UUID organizerId, UUID id, UpdateEventRequest event) {
        ...
        if (!id.equals(event.getId())) {
            throw new EventUpdateException("Cannot update the ID of and event");
        }
